...
begin
   Result := FRegistro0001.Registro0110.New;
end;

function TBloco_0.Registro0111New: TRegistro0111;
begin
   Result := FRegistro0001.Registro0110.Items[FRegistro0001.Registro0110.Count -1].Registro0111.New;
end;
...
begin
   Result := FRegistro0001.Registro0140.Items[FRegistro0001.Registro0140.Count -1].Registro0150.New;
end;

function TBloco_0.Registro0190New: TRegistro0190;
begin
   Result := FRegistro0001.Registro0140.Items[FRegistro0001.Registro0140.Count -1].Registro0190.New;
end;

function TBloco_0.Registro0200New: TRegistro0200;
begin
   Result := FRegistro0001.Registro0140.Items[FRegistro0001.Registro0140.Count -1].Registro0200.New;
end;
...
begin
  ...
  begin
     ...
     begin
       ///
       Add( LFill('0110') +
            LFill( COD_INC_TRIB ) +    //Verificar criação da tabela no ACBrEPCBlocos
            LFill( IND_APRO_CRED ) +   //Verificar criação da tabela no ACBrEPCBlocos
            LFill( COD_TIPO_CONT ) ) ; //Verificar criação da tabela no ACBrEPCBlocos
       ///
       Registro0990.QTD_LIN_0 := Registro0990.QTD_LIN_0 + 1;
     end;
  end;
...
begin
  ...
  begin
     for intFor := 0 to Reg0110.Registro0111.Count - 1 do
     begin
        with Reg0110.Registro0111.Items[intFor] do
        begin
          ///
          Add( LFill('0111') +
               LFill( REC_BRU_NCUM_TRIB_MI,0,2 ) +
               LFill( REC_BRU_ NCUM_NT_MI,0,2 ) +
               LFill( REC_BRU_ NCUM_EXP,0,2 ) +
     ...
     FRegistro0111Count := FRegistro0111Count + Reg0110.Registro0111.Count;
  end;
end;
...
begin
  ...
  begin
     for intFor := 0 to Reg0200.Registro0208.Count - 1 do
     begin
        with Reg0200.Registro0208.Items[intFor] do
        begin
          Add( LFill('0208') +
               LFill( COD_TAB ) +   //Verificar criação da tabela no ACBrEPCBlocos
               LFill( COD_GRU ) +
               LFill( MARCA_COM ) ) ;
        end;
        Registro0990.QTD_LIN_0 := Registro0990.QTD_LIN_0 + 1;
     ...
     /// Variavél para armazenar a quantidade de registro do tipo.
     FRegistro0208Count := FRegistro0208Count + Reg0200.Registro0208.Count;
  end;
end;
