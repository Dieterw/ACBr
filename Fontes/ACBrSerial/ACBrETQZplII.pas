...
{Tipo de CÃ³digo de Barras - vai de 'a' atÃ© 't' e de 'A' atÃ© 'T'
 Largura da Barra Larga, Largura da Barra Fina - De 0 a 9 e de 'A' atÃ© 'O'}
...
begin
  ...
  if ((Integer(Orientacao) + 1) < 1) or ((Integer(Orientacao) + 1) > 4) then
     Raise Exception.Create(ACBrStr('Informe um valor entre 1 e 4 para OrientaÃ§Ã£o'));
