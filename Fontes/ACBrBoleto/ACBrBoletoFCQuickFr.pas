...
type
  ...
  TACBrBoletoFCQuickFr = class(TForm)
    ...
    RLLabel85: TQrLabel;
    txtDesconto2: TQrLabel;
    RLLabel86: TQrLabel;
    txtMoraMulta2: TQrLabel;
    RLLabel87: TQrLabel;
    ...
    txtReferencia3: TQRLabel;
    txtQuantidade3: TQRLabel;
