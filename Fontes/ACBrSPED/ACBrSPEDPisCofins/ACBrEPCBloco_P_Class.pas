...
begin
   Result    := FRegistroP001.RegistroP010.Items[FRegistroP001.RegistroP010.Count -1].RegistroP100.New;
end;
...
begin
  ...
  begin
    ...
    fRegistroP100Count := FRegistroP100Count + RegP010.RegistroP100.Count;//fRegistroP010Count + 1;
  end;
end;
...
begin
  ...
  begin
    ...
    fRegistroP200Count := FRegistroP200Count + RegP001.RegistroP200.Count;//fRegistroP010Count + 1;
  end;
end;
end.
