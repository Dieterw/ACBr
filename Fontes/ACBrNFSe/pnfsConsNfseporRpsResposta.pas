...
begin
  ...
  try
    ...
    begin
      // Ler a NFSe
      i := 0;
      while Leitor.rExtrai(2, Prefixo3 + 'CompNfse', '', i + 1) <> '' do
      begin
           ...
           then begin
            ...
            if Leitor.rExtrai(6, Prefixo4 + 'Valores') <> ''
             then begin
              ...
              ListaNfse.FCompNfse[i].FNFSe.Servico.Valores.IssRetido              := StrToSimNao(ok, Leitor.rCampo(tcStr, Prefixo4 + 'IssRetido'));
      ...
      begin
        ...
        begin
          ...
          ListaNfse.FMsgRetorno[i].FCodigo   := Leitor.rCampo(tcStr, prefixo2 + 'Codigo');
          ListaNfse.FMsgRetorno[i].FMensagem := Leitor.rCampo(tcStr, prefixo2 + 'Mensagem');
          ListaNfse.FMsgRetorno[i].FCorrecao := Leitor.rCampo(tcStr, prefixo2 + 'Correcao');
