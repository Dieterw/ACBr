     ...
     begin
        ...
        begin
          ...
          Add( LFill('M100') +
               ...
               LFill( IND_CRED_ORI ) +    //Verificar criação da tabela no ACBrEPCBlocos
               LFill( VL_BC_PIS,0,2 ) +
               LFill( ALIQ_PIS,0,2 ) +
               ...
               LFill( IND_DESC_CRED ) +  //Verificar criação da tabela no ACBrEPCBlocos
  ...
  begin
     ...
     begin
        ...
        begin
          ...
          Add( LFill('M110') +
               LFill( IND_AJ ) +        //Verificar criação da tabela no ACBrEPCBlocos
               LFill( VL_AJ ,0,2 ) +
               LFill( COD_AJ ) +        //Verificar criação da tabela no ACBrEPCBlocos
               LFill( NUM_DOC ) +
               LFill( DESCR_AJ ) +
               LFill( DT_REF ) ) ;
        end;
  ...
  begin
     ...
     begin
        ...
        begin
          ...
          Add( LFill('M210') +
               LFill( COD_CONT ) +        //Verificar criação da tabela no ACBrEPCBlocos
...
begin
  ...
  begin
     ...
     begin
       ...
       Add( LFill('M211') +
            LFill( IND_TIP_COOP ) +        //Verificar criação da tabela no ACBrEPCBlocos
...
//               LFill( VL_CONT_APUR_DIFER,0,2 ) +
               LFill( NAT_CRED_DESC ) +         //Verificar criação da tabela no ACBrEPCBlocos
